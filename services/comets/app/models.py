...
class Observation(BaseModel):
    ...
    observation_time = fields.DatetimeField()
    comet: fields.ForeignKeyRelation["Comet"] = fields.ForeignKeyField(
        "models.Comet", related_name="observations", on_delete=fields.CASCADE, null=True
    )
...
class CometOrbit(BaseModel):
    uuid = fields.UUIDField(pk=True)
    comet: fields.ForeignKeyRelation["Comet"] = fields.ForeignKeyField(
        "models.Comet", related_name="orbits", on_delete=fields.CASCADE, null=True
    )
    semi_major_axis = fields.FloatField()
    eccentricity = fields.FloatField()
    inclination = fields.FloatField()
    longitude_ascending = fields.FloatField()
